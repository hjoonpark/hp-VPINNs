...
class VPINN:
    ...
    def __init__(self, XT_u_train, u_train, XT_f_train, XT_quad, W_quad,\
        ...
        self.x_f_tf = tf.compat.v1.placeholder(tf.float64, shape=[None, self.x_f.shape[1]])
        self.t_f_tf = tf.compat.v1.placeholder(tf.float64, shape=[None, self.t_f.shape[1]])

        self.x_test = tf.compat.v1.placeholder(tf.float64, shape=[None, self.xtest.shape[1]])
        self.t_test = tf.compat.v1.placeholder(tf.float64, shape=[None, self.ttest.shape[1]])
        self.x_quad = tf.compat.v1.placeholder(tf.float64, shape=[None, self.xquad.shape[1]])
        self.t_quad = tf.compat.v1.placeholder(tf.float64, shape=[None, self.tquad.shape[1]])
